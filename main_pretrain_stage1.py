...
def parse_option():
    ...
    parser.add_argument("--data-path",default="/home/share/Data/LHRS/PretrainData", type=str, help="path to dataset")
    ...
    parser.add_argument(
        "--enable-amp", type=str2bool, default=True, help="mixed precision"
    )
    parser.add_argument(
        "--output",
