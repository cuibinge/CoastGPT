...
def parse_option():
    ...
    parser.add_argument("--data-path",default='/home/ma-user/work/data/Stage2Data/fMoW_Image', type=str, help="path to dataset")
    parser.add_argument("--workers", type=int, default=8, help="workers of dataloader")
    parser.add_argument("--model-path",type=str, default="/home/ma-user/work/weights/FINAL.pt",help="pretrained checkpoint path")
