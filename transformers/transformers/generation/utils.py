    ...
    def generate(
        ...
        **kwargs,
        ...
        if generation_mode == GenerationMode.GREEDY_SEARCH:
            ...
            print("Use CONSTRAINED_BEAM_SEARCH")
            final_constraints = []
