...
def parse_option():
    ...
    # basic
    parser.add_argument("--config", type=str, default="./Configs/step2_dual.yaml", help="config file path")
    parser.add_argument("--batch-size", default=1,type=int, help="batch size for single GPU")
    parser.add_argument("--data-path",default='../Stage2Data/fMoW_Image', type=str, help="path to dataset")
    parser.add_argument("--workers", type=int, default=8, help="workers of dataloader")
    parser.add_argument("--model-path",type=str, default="./FINAL.pt",help="pretrained checkpoint path")
    ...
    config = ml_collections.ConfigDict(yaml_config)
